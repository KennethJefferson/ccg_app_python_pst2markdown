...
- Replaced markdownify with html2text for HTML to Markdown conversion
- Cleaner output for newsletter-style emails with complex HTML tables
- Better preservation of headings, lists, bold/italic formatting
...
- Convert HTML email bodies to Markdown using html2text
